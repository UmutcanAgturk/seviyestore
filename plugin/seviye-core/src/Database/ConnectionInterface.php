...
interface ConnectionInterface
{
    ...
    /**
     * The auto-increment ID generated by the most recent {@see insert()} on
     * this connection. Only meaningful immediately after a successful
     * insert into a table with an AUTO_INCREMENT primary key.
     */
