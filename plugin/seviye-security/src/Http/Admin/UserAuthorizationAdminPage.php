...
final class UserAuthorizationAdminPage
{
    ...
    public function handleSave(): void
    {
        ...
        if ($passwordInput !== '') {
            ...
            // password - the next request (any REST call, e.g. this same
            // page's own reload) would otherwise see them as logged out.
            // Re-issuing the auth cookie immediately is exactly what
