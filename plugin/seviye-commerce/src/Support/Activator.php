...
final class Activator
{
    public static function activate(): void
    {
        ...
        if (!class_exists(BranchesModule::class)) {
            self::abort(__('Seviye Commerce requires Seviye Branches to be installed and active.', 'seviye-commerce'));
        }
        ...
        // Binds this module's services and registers its migration
        ...
        // pattern and its full rationale. Branches, Students and Pricing
        // must already be active (checked above) so their Contracts
        // bindings this module depends on are available in the shared
        // container by the time boot() runs.
