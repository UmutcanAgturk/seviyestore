...
function scp_sidebar_sections(): array
{
    ...
    if (current_user_can('scp_manage_tax_rates')) {
    ...
    if (current_user_can('scp_manage_shop_showcase')) {
        $groups['katalog'][scp_menu_page_path('magaza-vitrini')] = __('Mağaza Vitrini', 'seviye-storefront');
    }
